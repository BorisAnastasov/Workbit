    ...
    public class ApplicationUserConfiguration : IEntityTypeConfiguration<ApplicationUser>
    {
        ...
        private static List<ApplicationUser> SeedApplicationUsers()
        {
            ...
            var userInfos = new (Guid Id, string Username, string FirstName, string LastName, string Email, DateTime Dob)[]
            {
                ...
                (Guid.Parse("e1a2b3c4-1111-4a1a-8b2b-111111111101"), "ivy.m.chen", "Ivy", "Chen", "ivy.m.chen@workbit.com", new DateTime(1996, 5, 21)),
                (Guid.Parse("e1a2b3c4-1111-4a1a-8b2b-111111111102"), "jack.d.miller", "Jack", "Miller", "jack.d.miller@workbit.com", new DateTime(1993, 9, 3)),
                (Guid.Parse("e1a2b3c4-1111-4a1a-8b2b-111111111103"), "karen.l.silva", "Karen", "Silva", "karen.l.silva@workbit.com", new DateTime(1994, 11, 27)),
                (Guid.Parse("e1a2b3c4-1111-4a1a-8b2b-111111111104"), "leo.p.novak", "Leo", "Novak", "leo.p.novak@workbit.com", new DateTime(1992, 1, 8)),
