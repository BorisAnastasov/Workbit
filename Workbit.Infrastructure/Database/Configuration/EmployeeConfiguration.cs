        ...
        public void Configure(EntityTypeBuilder<Employee> builder)
        {
            builder.HasData(
                new Employee
                {
                    ...
                    JobId = 1,
                    Level = JobLevel.Mid,
                    IBAN = "BG80BNBG96611020345678" // Bulgaria
                },
                new Employee
                {
                    ...
                    IBAN = "IT60X0542811101000000123456" // Italy
                },
                new Employee
                {
                    ...
                    JobId = 2,
                    Level = JobLevel.Lead,
                    IBAN = "ES9121000418450200051332" // Spain
                },
                new Employee
                {
                    ...
                    IBAN = "RO49AAAA1B31007593840000" // Romania
                },
                new Employee
                {
                    ...
                    JobId = 3,
                    Level = JobLevel.Mid,
                    IBAN = "NL91ABNA0417164300" // Netherlands
                },
                new Employee
                {
                    ...
                    JobId = 3,
                    Level = JobLevel.Junior,
                    IBAN = "PL61109010140000071219812874" // Poland
                },
                new Employee
                {
                    ...
                    JobId = 4,
                    Level = JobLevel.Senior,
                    IBAN = "SE3550000000054910000003" // Sweden
                },
                new Employee
                {
                    ...
                    JobId = 4,
                    Level = JobLevel.Lead,
                    IBAN = "IE29AIBK93115212345678" // Ireland
                }
            );
        }
